...
# ──────────────────────────────────────────────
export ANDROID_KEYSTORE_PATH="$HOME/.android/easyhealth-release.keystore"
export ANDROID_KEYSTORE_PASSWORD="cmOCI0aV3TLPZcjHKIALy1jjbk"
export ANDROID_KEY_ALIAS="easyhealth"
export ANDROID_KEY_PASSWORD="cmOCI0aV3TLPZcjHKIALy1jjbk"
export ANDROID_VERSION_CODE="1"
export ANDROID_VERSION_NAME="1.0.0-local"
...
cp android-config/gradle/wrapper/gradle-wrapper.properties android/gradle/wrapper/gradle-wrapper.properties

# ──────────────────────────────────────────────
# 5. Sync Capacitor (plugins + assets)
# ──────────────────────────────────────────────
