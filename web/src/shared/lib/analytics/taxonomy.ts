...
export const EVENT_SINKS = {
  ...
  installation_id_regenerated: ["server"] as Sink[],
  ...
  auth_api_error: ["server","ga4"] as Sink[],
  signup_started: ["server","ga4"] as Sink[],
  signup_completed: ["server","ga4"] as Sink[],
  login_started: ["server","ga4"] as Sink[],
  login_completed: ["server","ga4"] as Sink[],
  login_failed: ["server","ga4"] as Sink[],
  logout_completed: ["ga4"] as Sink[],
  social_login_started: ["server","ga4"] as Sink[],
  ...
  exercise_weight_changed: ["server","ga4"] as Sink[],
  exercise_set_completion_attempted: ["server","ga4"] as Sink[],
  exercise_set_completed: ["server","ga4"] as Sink[],
  exercise_load_progressed: ["server","ga4"] as Sink[],
  workout_exercise_completed: ["server","ga4"] as Sink[],
  ...
  anonymous_plan_limit_reached: ["server","ga4"] as Sink[],
  anonymous_workouts_claim_succeeded: ["server","ga4"] as Sink[],
  anonymous_workouts_claim_failed: ["server","ga4"] as Sink[],
  ...
  email_auth_started: ["server"] as Sink[],
  email_auth_succeeded: ["server"] as Sink[],
  email_auth_failed: ["server"] as Sink[],
