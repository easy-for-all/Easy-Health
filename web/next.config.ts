...
const securityHeaders = [
  ...
  // CSP: unsafe-inline required for Next.js hydration; unsafe-eval only in dev (React Turbopack debug)
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://www.google.com https://www.google.com.br https://*.googletagmanager.com https://c.clarity.ms",
      `connect-src 'self' https: https://www.google-analytics.com https://*.sentry.io https://*.clarity.ms${process.env.NODE_ENV === "development" ? " http://localhost:*" : ""}`,
      "font-src 'self'",
